...
def generate_configs():
    ...
    """
    if not os.path.exists('columbia_configs'):
        os.makedirs('columbia_configs')
    ...
    with open('./columbia_devices/spine.list') as spineinv:
        spines = spineinv.readlines()
    with open('./columbia_devices/core.list') as coreinv:
